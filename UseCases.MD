...
The user can likes posts or removes his likes from posts and enters admin key for becoming admin. And the guest can only look at the content without changing it in any way.
### 2) Use Case Diagram
